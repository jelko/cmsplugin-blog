...
urlpatterns = patterns('',
    ...
    (r'^feed/$', redirect_to, {'url': '/feed/rss/'}),

    (r'^feed/rss/any/tagged/(?P<tag>[^/]*)/$', TaggedEntriesFeed(), {'any_language': True}, 'blog_rss_any_tagged'),

    (r'^feed/rss/tagged/(?P<tag>[^/]*)/$', TaggedEntriesFeed(), {}, 'blog_rss_tagged'),

    (r'^feed/rss/any/author/(?P<author>[^/]*)/$', AuthorEntriesFeed(), {'any_language': True}, 'blog_rss_any_author'),

    (r'^feed/rss/author/(?P<author>[^/]*)/$', AuthorEntriesFeed(), {}, 'blog_rss_author'),

    (r'^feed/rss/any/$', EntriesFeed(), {'any_language': True}, 'blog_rss_any'),

    (r'^feed/rss/$', EntriesFeed(), {}, 'blog_rss'),

    (r'^feed/atom/any/tagged/(?P<tag>[^/]*)/$', TaggedEntriesFeed(generator=Atom1Feed), {'any_language': True}, 'blog_atom_any_tagged'),

    (r'^feed/atom/tagged/(?P<tag>[^/]*)/$', TaggedEntriesFeed(generator=Atom1Feed), {}, 'blog_atom_tagged'),

    (r'^feed/atom/any/author/(?P<author>[^/]*)/$', AuthorEntriesFeed(generator=Atom1Feed), {'any_language': True}, 'blog_atom_any_author'),

    (r'^feed/atom/author/(?P<author>[^/]*)/$', AuthorEntriesFeed(generator=Atom1Feed), {}, 'blog_atom_author'),
